      ...
      <section id="main-content">
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel" style="height: 500px;">
                      ...
                      <form class="form-horizontal style-form" method="post">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input  name="metin" type="text" class="form-control">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                              <input  name="metin1" type="text" class="form-control round-form">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Haber</label>
                              <div class="col-sm-10">
                              <input  name="metin2" type="text" class="form-control round-form">
                              </div>
                                </div>
                          <div class="form-group">
                        ...
                        <input name="message" type="file"><br>   
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                              <input  name="metin3" type="text" class="form-control round-form">
                              </div>
                ...
                <?php 
                   if($_POST){
                     $Haber_Tur = $_POST["liste"];
                    $Baslik= $_POST['metin'];
                    $Haber_On= $_POST['metin1'];
                    $Haber = $_POST['metin2'];
                    $Tarih = $_POST["metin3"];
                    $Foto = $_POST["message"];
 
                     mysqli_query($baglan,"insert into haberler(Haber_Tur,Baslik,Haber_On,Haber,Tarih,Foto) values('$Haber_Tur','$Baslik','$Haber_On','$Haber','$Tarih','$Foto') ");
                    echo" başaryla eklendi";
                   } 
 ?> 
