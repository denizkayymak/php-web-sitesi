                  ...
                  <div class="form-panel" style="height: 500px;">
                      ...
                      <form class="form-horizontal style-form" method="post">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input  name="metin" type="text" class="form-control" value="<?=$satir['Baslik']?>" >
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                              <input  name="metin1" type="text" class="form-control round-form" value="<?=$satir['Haber_On']?>">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Haber</label>
                              <div class="col-sm-10">
                              <input  name="metin2" type="text" class="form-control round-form" value="<?=$satir['Haber']?>">
                              </div>
                                </div>
                          <div class="form-group">
                        ...
                        <input name="message" type="file" value="<?=$satir['Foto']?>"><br>   
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                              <input  name="metin3" type="text" class="form-control round-form" value="<?=$satir['Tarih']?>">
                              </div>
